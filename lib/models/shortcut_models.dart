...
/// Display names for these enums live in `lib/l10n/model_labels.dart`, so the
/// model layer never holds user-visible copy.
...
enum ShortcutTargetType { video, shortVideo, playlist, channel }
