...
class ShortcutBackupException implements Exception {
  const ShortcutBackupException(this.message);
...
class ShortcutBackupService {
  ...
  List<ShortcutEntry> decode(String raw) {
    if (raw.trim().isEmpty) {
      throw const ShortcutBackupException('The selected file is empty.');
    }
    ...
    if (decoded is! Map<String, dynamic>) {
      throw const ShortcutBackupException(
        'The selected file is not a YT Shortcuts backup.',
      );
    }
